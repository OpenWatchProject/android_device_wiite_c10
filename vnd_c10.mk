MTK_TARGET_PROJECT := c10
MTK_BASE_PROJECT := c10
...
KERNEL_DEFCONFIG ?= c10_debug_defconfig
else
KERNEL_DEFCONFIG ?= c10_defconfig
endif
PRELOADER_TARGET_PRODUCT ?= c10
LK_PROJECT ?= c10
TRUSTY_PROJECT ?= c10
